public class ApplicationGlobalState {
    ...
    public static final String API_KEY = "HxDnrWd1rfxDZ4UkOff6Gh6BETl9qa75";
    ...
    public String getBaseHost() {return BASE_HOST;}
    public String getLocations() {return LOCATIONS;}
    public String getTopCities() {return TOP_CITIES;}
    public String getApiVersion() {return API_VERSION;}
    public String getScheme() {return SCHEME;}
    public String getCitiesNumber() {return CITIES_NUMBER;}
