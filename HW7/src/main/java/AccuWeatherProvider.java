...
public class AccuWeatherProvider {
    ...
    public void showResult( Weather weather) {
        System.out.println("В городе " + ApplicationGlobalState.getInstance().getSelectedCity() + " на дату " + weather.getDate() +
                " ожидается " + weather.getText() + ", температура - " + weather.getTemperature() + ".");
    }
